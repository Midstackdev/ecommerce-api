...
class CartTest extends TestCase
{
    ...
    public function test_it_returns_money_instance_for_the_subtotal()
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
    ...
    public function test_it_returns_money_instance_for_the_total()
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
    ...
    public function test_it_returns_products_in_the_cart()
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
