...
class ProductVariationTest extends TestCase
{
    ...
    public function test_it_returns_a_product_price_if_the_price_is_null()
    {
    ...
    public function test_it_has_in_stock_pivot_within_stock_information()
    {
        ...
        $this->assertTrue((boolean)$variation->stock->first()->pivot->in_stock);
    }

    public function test_it_can_check_if_its_stock()
    {
        $variation = factory(ProductVariation::class)->create();
    ...
    public function test_it_can_check_the_min_stock_for_a_given_product()
    {
        $variation = factory(ProductVariation::class)->create();
